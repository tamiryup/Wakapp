...
var MainwinObj = new MainwinHelper($, alarmControllers, AlarmsMng.locationAlarms, middleLines, //
doneEdit, trash, save, "AddLocation", openAdd, engageEditMode, exitEditMode, trashFunc);
...
function save(args) {
	$.off("saveAlarm", save);
	var locAlarm = new LocationAlarm(args.name, args.locationName, args.location, args.radius, args.placeId, //
	args.sounds, args.formattedAddress, args.locationTypes);
	var index = AlarmsMng.addToLocationAlarms(locAlarm);
	MainwinObj.saveHelper(locAlarm, index, args.isEdit);
	return index;
}
